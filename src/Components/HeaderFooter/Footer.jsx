...
<footer className="flex z-10 bg-pink-100 pb-10 pt-20 dark:bg-dark justify-between px-20 lg:pb-20 lg:pt-[120px]">
      ...
      <div className='flex gap-10'>
            <Link>
              <span className=' text-gray-700 text-2xl font-bold'>Resources</span>
              <div className='flex flex-col gap-3 pt-5 text-gray-500 text-xl'>
            ...
            <Link >
            <span className=' text-gray-700 text-2xl font-bold'>Company</span>
              <div className='flex flex-col gap-3 pt-5 text-gray-500 text-xl'>
              <span>About TailGrids</span>
            ...
            <Link>
            <span className=' text-gray-700 text-2xl font-bold'>Quick Links</span>
             <div className='flex flex-col gap-3 pt-5 text-gray-500 text-xl'>
